...
--
-- Host: 127.0.0.1
-- Tempo de geração: 16-Mar-2022 às 02:13
...
(72, 'vela de ignição', 10.5, 78.33, 6),
(73, 'oleo de motor', 2.56, 25, 7),
(74, 'parabrisa palio', 125, 235.25, 0),
(75, 'motor de partida ', 123, 786.47, 6),
(76, 'escapamento fiat uno 1.0', 789, 1897.54, 0),
(77, 'cliciane costa da silva nobreozeassilva nobre', 5, 10, 2);
...
(9, 1, 1, '2022-03-15', 235.25, 'dinheiro'),
(10, 1, 1, '2022-03-15', 796.47, 'dinheiro'),
(11, 1, 1, '2022-03-15', 10, 'cartao');
...
(14, 9, 74, 1, 235.25, 235.25),
(15, 10, 77, 1, 10, 10),
(16, 10, 75, 1, 786.47, 786.47),
(17, 11, 77, 1, 10, 10);
...
--
ALTER TABLE `vendas_produtos`
  MODIFY `id_vendas_produtos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
COMMIT;
